...
def main():
    try:
        carplate_img_rgb = open_img(img_path=r'cars/1.jpg')
        carplate_haar_cascade = cv2.CascadeClassifier(r'haar_cascade/haarcascade_russian_plate_number.xml')
        ...
        detected_license_plate = pytesseract.image_to_string(
            carplate_extract_img_gray,
            config='--psm 6 --oem 3 -c tessedit_char_whitelist=ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789'
        )
        print('Номер авто: ', detected_license_plate)
